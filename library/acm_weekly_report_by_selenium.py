...
def main():
    ...
    # ウィンドウサイズを調整
    driver.set_window_size(760,1280)
    ...
    try:
        time.sleep(3)
        # Weekly Reportボタンクリック
        print('Debug2: Weekly Reportボタンクリック')
        driver.find_element_by_class_name("send_weekly_report").click()
        time.sleep(3)
    except:
        print(' Failed: [Send Weekly Report] ボタンのクリックに失敗しました。終了します。')
    else:
        print(' Success: [Send Weekly Report] ボタンのクリックに成功しました。')
